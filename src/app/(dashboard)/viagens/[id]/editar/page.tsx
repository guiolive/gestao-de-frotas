    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                name="dataSaida"
                type="datetime-local"
                defaultValue={formatDatetimeLocal(viagem.dataSaida)}
            ...
            <div>
              ...
              <input
                name="dataRetorno"
                type="datetime-local"
                defaultValue={formatDatetimeLocal(viagem.dataRetorno)}
                className={inputClass}
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <input
                ...
                type="number"
                step="0.1"
                defaultValue={viagem.kmPorTrecho ?? ""}
                className={inputClass}
              />
            </div>
            <div>
          ...
          <div>
            ...
            <input
              ...
              type="number"
              step="0.01"
              defaultValue={viagem.totalDiarias ?? ""}
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          >
            <h2 className="text-lg font-semibold text-gray-800">PCDP Motorista 1</h2>
